...
\mathbf{SSCP} = \begin{bmatrix} 
  ...
  \end{bmatrix}
$$
Also note that the **SSCP** matrix is symmetric.
...
Similar to the **SSCP** matrix, $\boldsymbol{\Sigma}$ is also a symmetric matrix. 
...
$$
Since both **S** and $\boldsymbol{\Sigma}$ are $4 \times 4$ matrices, **R** will also be a $4 \times 4$ matrix.
