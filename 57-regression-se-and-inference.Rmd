...
for each *j*. To test this we compute a *t*-statistic based on the ratio of the coefficent estimate and that its associated standard error. This is evaluted in a *t*-distribution having $n-k$ degrees of freedom. (See [here](https://zief0002.github.io/modeling/coefinf.html#coefinf) for a reminder about the coefficient-level tests.) Using our toy-example:
